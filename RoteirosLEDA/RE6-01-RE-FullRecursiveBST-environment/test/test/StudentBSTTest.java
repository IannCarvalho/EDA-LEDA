...
import adt.bst.extended.FullRecursiveBSTImpl;
import adt.bt.BTNode;

public class StudentBSTTest {

	private FullRecursiveBSTImpl<Integer> tree;
	...
	public void testElementsAt(){
		...
		assertArrayEquals(order, tree.elementsAtDistance(2));
	}
}
